...
def main():
    ...
    reload_checkpoint = '/data/sft_lab/fzq/CRNN/data/checkpoints/crnn.pt'
    ...
    test_dataset = Synth90kDataset(root_dir=config['data_dir'], image_dir='/data/sft_lab/fzq/CRNN/data/images/',mode='test',
