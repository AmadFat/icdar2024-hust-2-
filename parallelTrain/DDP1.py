...
"""Can be start with:
torchrun --nproc_per_node 4 --nnodes 1 --node_rank 0 --master_addr=localhost --master_port=12658 DDP1.py
...
os.system('torchrun --nproc_per_node 4 --nnodes 1 --node_rank 0 --master_addr=localhost --master_port=12658 DDP1.py')